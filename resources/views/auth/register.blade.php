...
<head>
    ...
    <title>Daftar | Donat-in azza</title>
    <style>
        :root {
            --pink-50: #FFF0F5;
            --pink-100: #FFE3EE;
...
<body>
    <div class="auth-card">
        ...
        <h2 style="margin-bottom: 0.5rem; color: var(--dark);">Daftar Akun Baru</h2>
        <p style="color: #5A5557; font-size: 0.9rem; margin-bottom: 2rem;">Yuk gabung jadi Member Manis sekarang!</p>
        ...
        <form method="POST" action="/register">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Contoh: Dinda Kirana" value="{{ old('name') }}" required autofocus>
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" class="form-control" placeholder="Contoh: aku@email.com" value="{{ old('email') }}" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" style="margin-top: 1rem;">Daftar</button>
        </form>
